...
**5. It will cause error. Because we change let instead of var of the whole variables. And we difine i in the for loop, it can't be used out of it.**\
**6. It will cause error. Because we change let instead of var of the whole variables. And we difine discountPrice in the for loop, it can't be used out of it.**\
